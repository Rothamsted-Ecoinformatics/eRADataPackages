...
package = Package()
package.infer('Hackathon data/BroadbalkChemistry/broadbalkSoilChemistryData.csv')

package.descriptor['resources'][0]['schema']['fields'][0]['type']='number'
package.descriptor['resources'][0]['schema']['fields'][0]['description']='The Broadbalk strip'

package.descriptor['resources'][0]['schema']['fields'][1]['type']='string'
package.descriptor['resources'][0]['schema']['fields'][1]['description']='The N rate since 2015'

package.descriptor['resources'][0]['schema']['fields'][2]['type']='string'
package.descriptor['resources'][0]['schema']['fields'][2]['description']='Other fertilisers regime since 2015'

package.descriptor['resources'][0]['schema']['fields'][3]['type']='text'
package.descriptor['resources'][0]['schema']['fields'][3]['description']='What the measured variable is (Olsen P, soil carbon, total N)'

package.descriptor['resources'][0]['schema']['fields'][4]['type']='number'
package.descriptor['resources'][0]['schema']['fields'][4]['description']='the measured value (note 1843 values are estimated)'

package.descriptor['resources'][0]['schema']['fields'][5]['type']='string'
package.descriptor['resources'][0]['schema']['fields'][5]['description']='measurement unit'

package.descriptor['resources'][0]['schema']['fields'][6]['type']='string'
package.descriptor['resources'][0]['schema']['fields'][6]['description']='Note code'

package.descriptor['resources'][0]['schema']['fields'][7]['type']='string'
package.descriptor['resources'][0]['schema']['fields'][7]['description']='Whether wheat is from a continuous or rotational section.'
